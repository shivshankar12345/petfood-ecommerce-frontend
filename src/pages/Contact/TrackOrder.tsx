...
const TrackOrder: React.FC = () => {
  ...
  const handleTrackOrder = () => {
    if (orderID) {
      // Uncomment the following line to enable API call when ready
    ...
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      <div className="flex items-center mb-8 gap-2">
        <input
          ...
          className="w-full px-4 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring focus:border-blue-400"
        />
        <button
