...
const Footer = () => {
  ...
  async function fetchContact() {
    ...
    if (!isError && response?.data) {
      ...
      const email = response.data.contacts.filter(
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/dogs" className="hover:text-teal-500">
                  Dogs
                </a>
              </li>
              <li>
                <a href="/cats" className="hover:text-teal-500">
                  Cats
                </a>
              </li>
              <li>
                <a href="/small-pets" className="hover:text-teal-500">
                  Small Pets
                </a>
              </li>
              <li>
                <a href="/consult-vet" className="hover:text-teal-500">
                  Consult a Vet
                </a>
              </li>
              <li>
                <a href="/dog-behaviour" className="hover:text-teal-500">
                  Dog Behaviour
                </a>
              </li>
              <li>
                <a href="/pet-pharmacy" className="hover:text-teal-500">
                  Pet Pharmacy
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/our-story" className="hover:text-teal-500">
                  Our story
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/my-account" className="hover:text-teal-500">
                  My Account
                </a>
              </li>
              <li>
                <a href="/track-order" className="hover:text-teal-500">
                  Track Your Order
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/return-policy" className="hover:text-teal-500">
                  Return policy
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/terms-of-use" className="hover:text-teal-500">
                  Terms of Use
                </a>
              </li>
              <li>
                <a href="/refer-and-save" className="hover:text-teal-500">
                  Refer and save
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 pt-6 mt-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 text-sm">
            <a href="/dog-food" className="hover:text-teal-500">
              Dog Food
            </a>
            <a href="/dog-collars" className="hover:text-teal-500">
              Dog Collars Leashes Harnesses
            </a>
            <a href="/me-o" className="hover:text-teal-500">
              Me-O
            </a>
            <a href="/cat-clothes" className="hover:text-teal-500">
              Cat Clothes
            </a>
            <a href="/cat-litter" className="hover:text-teal-500">
              Cat Litter
            </a>
            <a href="/dog-raincoat" className="hover:text-teal-500">
              Dog Raincoat
            </a>
        ...
        <div className="border-t border-gray-700 pt-6 mt-6 text-center">
          ...
          <p>
            1335, 11th Cross Rd, Stage 3, Indiranagar, Bengaluru, Karnataka
            560038
          </p>
        </div>
      </div>
